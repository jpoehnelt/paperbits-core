...
import template from "./tabsItemEditor.html";
import { ViewManager } from "@paperbits/common/ui";
import { Component, Param, Event, OnMounted } from "@paperbits/common/ko/decorators";
import { TabsItemModel } from "../tabsModel";
import {
...
export class TabsItemEditor {
    ...
    @Param()
    public model: TabsItemModel;

    @Event()
    public onChange: (model: TabsItemModel) => void;
